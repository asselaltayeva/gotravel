      ...
      <div className="m-auto max-w-432 px-21.5">
        ...
        <div className="flex items-start justify-between gap-x-44 pt-26">
          <div className="max-w-min shrink-5">
            ...
            <a href="#ExploreMore"className="bg-primary-700 hover:bg-primary-800 cursor-pointer rounded-[0.625rem] px-8 py-3.5 text-lg font-medium text-white
            transition-all duration-200">Start your explore</a>
          </div>

          <figure className="relative shrink-2 px-20">
            <img src={swimmingDudes} alt="A photo of two men swimming"
            className="max-h-[50.9rem] rounded-[3.5rem]"/>
